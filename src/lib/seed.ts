...
export const seedHackathons: Hackathon[] = [
  {
    ...
    thumbnailUrl: "https://placehold.co/80x80/65a30d/ffffff?text=A8",
    period: {
      timezone: "Asia/Seoul",
  ...
  },
  {
    ...
    thumbnailUrl: "https://placehold.co/80x80/84cc16/ffffff?text=VB",
    period: {
      timezone: "Asia/Seoul",
  ...
  },
  {
    ...
    thumbnailUrl: "https://placehold.co/80x80/22c55e/ffffff?text=DH",
    period: {
      timezone: "Asia/Seoul",
...
export const seedHackathonDetails: HackathonDetail[] = [
  {
    slug: "aimers-8-model-lite",
    title: "Aimers 8기 : 모델 경량화 온라인 해커톤",
    sections: {
  ...
  },
  {
    ...
    sections: {
      overview: {
        summary: "바이브 코딩 경험을 개선하는 AI 아이디어를 제안하는 해커톤입니다.",
        teamPolicy: { allowSolo: true, maxTeamSize: 3 },
      },
      info: {
        notice: [
          "아이디어 기획서 형식으로 제출합니다.",
          "외부 API를 사용하는 경우 심사자가 키 없이 확인 가능해야 합니다.",
        ],
        links: {
          rules: "https://example.com/public/rules/vibe202602",
          faq: "https://example.com/public/faq/vibe202602",
      ...
      schedule: {
        timezone: "Asia/Seoul",
        milestones: [
          { name: "접수/기획서 제출 기간", at: "2026-02-04T10:00:00+09:00" },
          { name: "제출 마감", at: "2026-03-03T10:00:00+09:00" },
          { name: "투표 시작", at: "2026-03-03T12:00:00+09:00" },
          { name: "최종 결과 발표", at: "2026-03-09T10:00:00+09:00" },
        ],
      },
      prize: {
        items: [
      ...
      submit: {
        ...
        guide: [
          "아이디어 기획서를 텍스트 또는 URL로 제출합니다.",
          "제출 후 투표 기간 동안 다른 팀의 아이디어를 평가해 주세요.",
        ],
        submissionItems: [
          { key: "plan", title: "기획서 제출", format: "text_or_url" },
        ],
      },
      leaderboard: {
    ...
    entries: [
      {
        ...
        artifacts: { webUrl: "https://404found.vercel.app", pdfUrl: "https://example.com/404found-solution.pdf", planTitle: "404found 기획서" },
      },
      {
        rank: 2,
        teamName: "LGTM",
        ...
        artifacts: { webUrl: "https://lgtm-hack.vercel.app", pdfUrl: "https://example.com/lgtm-solution.pdf", planTitle: "LGTM 기획서" },
      },
    ],
  },
];
